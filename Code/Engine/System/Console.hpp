...
class CXConsole : public IConsole, public IRemoteConsoleListener, public IInputEventListener, public IConsoleVarSink
{
...
public:
	...
	ICVar*              RegisterCVarGroup(const char* szName, const char* szFileName);
...
protected:
	...
	void ConsoleLogInput(const char* szFormat, ...);
	PRINTF_PARAMS(2, 3);
	...
	virtual ICVar*     RegisterInternal(ICVar* pVar)
	{
		RegisterVar(pVar->GetName(), pVar);
		return pVar;
	}
