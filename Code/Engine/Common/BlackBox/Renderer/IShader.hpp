...
public:
	...
	virtual EF_Sort     GetSort() { return {}; }
	virtual int         GetFlags() { return {}; }
	virtual int         GetFlags2() { return {}; }
	virtual int         GetFlags3() { return {}; }
	virtual int         GetRenderFlags() { return {}; }
	virtual void        SetRenderFlags(int nFlags) { return; }
	virtual int         GetLFlags() { return {}; }
	virtual int         GetCull() { return {}; }
	virtual uint        GetPreprocessFlags() { return {}; }
	virtual void        SetFlags3(int Flags) { return; }
	virtual bool        Reload(int nFlags) { return {}; }
#if 0
	virtual TArray<CRendElement*>* GetREs()																															{ return {}; }
#endif
	...
	virtual void          RemoveTemplate(int TemplId) { return; }
	virtual IShader*      GetTemplate(int num) { return {}; }
	virtual SEfTemplates* GetTemplates() { return {}; }
#if 0
	virtual TArray<SShaderParam>&  GetPublicParams()																												{ return {}; }
#endif
	virtual int GetTexId()
	{
		return {};
	}
	virtual ITexPic*         GetBaseTexture(int* nPass, int* nTU) { return {}; }
	virtual unsigned int     GetUsedTextureTypes(void) { return {}; }
	virtual int              GetVertexFormat(void) { return {}; }
