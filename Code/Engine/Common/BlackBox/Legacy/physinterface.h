...
//  Description: Physics System Interface.
//		Declarations of all physics interfaces and structures.
//
//	History:
//	- File created by Anton Knyazyev
...
class CMemStream
{ // for "fastload" serialization; hopefully it can be made global for the project
public:
	CMemStream()
	{
...
{ //	Sets postion and orientation of entity
	enum entype
	{
		type_id = 0
	};
...
{ // Sets gravity and maximum time step
	enum entype
	{
		type_id = 10
	};
...
struct pe_params_softbody : pe_params
{
	...
	{
		type = type_id;
		MARK_UNUSED thickness, maxSafeStep, ks, kdRatio, airResistance, wind, nMaxIters,
