...
#define CHECK_SCRIPT_FUNCTION_PARAMCOUNT2(scriptsystem, objectname, funcname, nparameters, nparameters2)                                                                             \
	{                                                                                                                                                                                \
		...
		{                                                                                                                                                                            \
			scriptsystem->RaiseError("%s:%s() Wrong number of parameters! Expected %d or %d, but found %d!", objectname, #funcname, nparameters, nparameters2, pH->GetParamCount()); \
			return pH->EndFunctionNull();                                                                                                                                            \
		}                                                                                                                                                                            \
	}
#define CHECK_SCRIPT_FUNCTION_PARAMTYPE(scriptsystem, objectname, funcname, idparam, type)                                                                                                                                   \
	{                                                                                                                                                                                                                        \
		...
		{                                                                                                                                                                                                                    \
			scriptsystem->RaiseError("%s:%s() Wrong type in parameter %d! Expected '%s', but found '%s'!", objectname, #funcname, idparam, GET_SCRIPT_TYPE_STRING(type), GET_SCRIPT_TYPE_STRING(pH->GetParamType(idparam))); \
			return pH->EndFunctionNull();                                                                                                                                                                                    \
		}                                                                                                                                                                                                                    \
	}
#define CHECK_SCRIPT_FUNCTION_PARAMTYPE2(scriptsystem, objectname, funcname, idparam, type, type2)                                                                                                                                                                  \
	{                                                                                                                                                                                                                                                               \
		...
		{                                                                                                                                                                                                                                                           \
			scriptsystem->RaiseError("%s:%s() Wrong type in parameter %d! Expected '%s' or '%s', but found '%s'!", objectname, #funcname, idparam, GET_SCRIPT_TYPE_STRING(type), GET_SCRIPT_TYPE_STRING(type2), GET_SCRIPT_TYPE_STRING(pH->GetParamType(idparam))); \
			return pH->EndFunctionNull();                                                                                                                                                                                                                           \
		}                                                                                                                                                                                                                                                           \
	}
#define CHECK_SCRIPT_FUNCTION_PARAMTYPE3(scriptsystem, objectname, funcname, idparam, type, type2, type3)                                                                                                                                                                                                \
	{                                                                                                                                                                                                                                                                                                    \
		...
		{                                                                                                                                                                                                                                                                                                \
			scriptsystem->RaiseError("%s:%s() Wrong type in parameter %d! Expected '%s', '%s' or '%s', but found '%s'!", objectname, #funcname, idparam, GET_SCRIPT_TYPE_STRING(type), GET_SCRIPT_TYPE_STRING(type2), GET_SCRIPT_TYPE_STRING(type3), GET_SCRIPT_TYPE_STRING(pH->GetParamType(idparam))); \
			return pH->EndFunctionNull();                                                                                                                                                                                                                                                                \
		}                                                                                                                                                                                                                                                                                                \
	}
